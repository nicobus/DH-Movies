<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark font-weight-bold">
        <a class="navbar-brand" href="#"><img src="/img/logo.png" width="80" height="80" alt="" loading="lazy"></a>
        ...
        <div class="collapse navbar-collapse my-4" id="navbarNavDropdown">
          ...
          <form class="form-inline my-4 my-lg-0 ml-auto">
            <input class="form-control mr-sm-2 my-2" type="search" placeholder="Ingrese el título de la película..." aria-label="Search">
